...
class AuthRequest(object):
    def __init__(
        self, method="GET", endpoint="/", payload=None, headers=None, params=None
    ):
        """
    ...
    def build_headers(self, client_type, client_id, signature):
        auth_string_format = (
            "{dci_algorithm} Credential={client_type}/{client_id}, "
    ...
    def _filter_headers(self, headers):
        ...
        if not authorization_header:
            return headers
        signed_headers = self.find_between(
